...
import {
  ...
  type SimpleEarnOptimizationInput,
  type DualInvestmentInput,
  type StablecoinYieldArbitrageInput,
  type LaunchpoolParkingInput,
  type LiquidityLadderInput,
  type EarnHurdleRateInput,
  type BnbVaultInput,
  type TierSaturationInput,
  type AutoInvestDcaInput,
  type InstantRedemptionInput,
  ...
  try {
    switch (skillName) {
      ...
      case 'qualify_direct_lead_and_close': {
        ...
        const primaryConcern = (args['primaryConcern'] || 'PRICE') as 'PRICE' | 'SECURITY' | 'SPEED' | 'PAYMENT_LIMITS';
