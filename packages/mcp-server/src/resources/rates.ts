...
import { getOfficialBcvRates, getParallelRatesFeed, calculateBcvGap, predictBcvIntervention } from '../core/index.js';
...
export const ratesResources: McpResource[] = [
  {
    ...
    description: 'Tasas de cambio oficiales publicadas por el Banco Central de Venezuela (USD, EUR, CNY, RUB)',
  ...
  },
  {
    ...
    description: 'Cotizaciones en vivo desde Binance P2P, CotizaVe, EnParaleloVzla y CriptoNoticias con estadísticas de dispersión',
    mimeType: 'application/json',
    read: () => {
  ...
  },
  {
    ...
    description: 'Brecha actual entre paralelo y oficial BCV junto a la ventana de intervención de subastas bancarias',
    mimeType: 'application/json',
    read: () => {
